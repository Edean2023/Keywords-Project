...
namespace scramble {
	const string words[10] = {
		"programming", "steam" , "lounge" , "radio" , "classroom", "dough" , "sculpture" , "accountant" , "hunter" , "future"
	};
	// This will store the hints that are related to the scrambled words
	const string hints[10] = {
		"What computer scientists do.",
		"Most popular game launcher.",
		"What people do to relax.",
		"Cars have this to play music.",
		"Schools have these.",
		"You use this to bake things.",
		"Artists construct these.",
		"A person who works with numbers.",
		"A person that catches animals.",
		"A later time."
	};
}
	class codeBreaker
